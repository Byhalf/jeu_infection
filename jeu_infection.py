...
#append prend trop de temps, add = list.append
    ...
    def is_terminal(self):
        """methode vérifiant si la partie est finie"""
...
class Player(ABC):
    """Une classe abstraire de joueur"""
    _counter = 0
    def __init__(self):
        Player._counter += 1
...
class Random_player(Player):
    """Un joueur jouant aléatoirement"""
    def __str__(self):
...
class MinMax(Player):
    """Un joeur utilisant l'algorithme minmax pour réfléchir"""
    noeud_explore = 0
    def __str__(self):
...
class AlphaBeta(Player):
    """Un joeur utilisant l'algorithme minmax avec un élagage alpha beta pour réfléchir"""
    noeud_explore = 0
    def __str__(self):
        return super().__str__() + "  alphaBeta"
    def __init__(self,profondeur):
        super().__init__()
        self.profondeur = profondeur
    def type_of_player(self):
...
print("total noeud exploré ",player1.noeud_explore+player2.noeud_explore)
...
for i in range(5):
    ...
    while(state.is_terminal() != True):
        ...
        state = state.play(move)
        #state.show_board()
    y1.append(player1.noeud_explore+player2.noeud_explore)
    ...
    while(state.is_terminal() != True):
        ...
        state = state.play(move)
        #state.show_board()
    y2.append(player1.noeud_explore+player2.noeud_explore)
